...
//---------------Hızlı W atma Etuşu Son---------------------------
var Wc = document.getElementById("canvas");
var Vc = Wc.getContext("2d");
function zb(a) {
        a.strokeStyle = "#FF0000", a.lineWidth = 20, a.beginPath(), a.moveTo(0, 0), a.lineTo(0, 25000), a.lineTo(25000, 25000), a.lineTo(25000, 0), a.closePath(), a.stroke()
    }
zb(Vc);
